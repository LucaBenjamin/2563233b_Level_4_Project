...
def convert_outs_to_audio(input_directory, output_directory, x_res, y_res):
...
# Example usage
input_dir = 'Evaluation//eval_100_ts'
output_dir = 'Evaluation//eval_100_ts_audio'
convert_outs_to_audio(input_dir, output_dir, x_res=512, y_res=512)
